...
class VQGANDataset_4x(Dataset):
    def __init__(self, root_dir=None, augmentation=False,split='train',stage = 1,patch_size = 64):
        ...
        self.patch_sampler_256 = tio.data.UniformSampler((256,256,64))  # For Stage 1 val (same as vqgan.py)
    ...
    def __getitem__(self, index):
        ...
        # Step 2: Apply padding if needed (with value 0)
        # Step 3: Convert [0, 1] to [-1, 1] BEFORE patching (so padding becomes -1)
        whole_img.data = whole_img.data * 2 - 1

        # Step 4: Apply padding and patching
